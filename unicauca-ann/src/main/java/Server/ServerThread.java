...
public class ServerThread extends Thread {
    ...
    public ArrayList<Task> tareas;
    public ArrayList algoritmos;
    ReentrantLock lock = new ReentrantLock();
    
    public ServerThread(Socket socket, int id, ArrayList<Task> tareas, ArrayList algoritmos) {
        this.socket = socket;
        this.idSessio = id;
        this.tareas = tareas;
                ...
                while (!takeTaks) {
                    ...
                    try {
                        if (tareas.isEmpty()) {
                            ...
                            aux = new Task(tareas.get(0).toString());
...
//                        }
    ...
    public void write(Task t, boolean sendMailResults) {
...
//            }
    ...
    public void writeTaskOnPath(String path, Task t) {
        boolean write = false;
    ...
    public void writeTareaEchas(Task t) {
    ...
    public void writeErrorTarea(String path, Task t) {
    ...
    public void comprimir() {
        try {
            ...
            Logger.getLogger(BuildExperiment.class
                    .getName()).log(Level.SEVERE, null, ex);
        }
    }
