...
//Example 2
//        input_weight.set(0, 0, 0.102);
//        input_weight.set(0, 1, 0.083);
//        input_weight.set(1, 0, 0.98);
//        input_weight.set(1, 1, 0.006);
//        input_weight.set(2, 0, 0.730);
//        input_weight.set(2, 1, 0.997);
...
//        bias.set(2, 0.474);
        ...
        System.out.println("" + elm.getOuputWightNorm2());
    }
