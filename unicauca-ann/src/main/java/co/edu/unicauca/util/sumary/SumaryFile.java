...
public class SumaryFile {
    ...
    public static void exportResult(Algorithm MyAlgoritm, LocalSearchOperator LS, AbstractELMEvaluator evaluator, List<DoubleSolution> Solutions, List AccList, List time, Problem problema, String descriptor) throws IOException {
        ...
        String path = "Result\\" + MyAlgoritm.getName() + "Result\\" + evaluator.getType() + "\\";

        String SumaryNameFile = path + descriptor + "_" + resultForFile + "_Results.txt";
        ...
        System.out.println("Result Writed in unicauca-ann " + SumaryNameFile);
